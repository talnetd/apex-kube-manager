...
<div class="h-full flex flex-col overflow-hidden">
  ...
  <div class="p-6 pb-4">
    <div class="flex items-center justify-between mb-4">
      <div>
        <h1 class="text-2xl font-semibold text-text-primary">DaemonSets</h1>
        <p class="text-text-muted mt-1">Ensure pods run on all or specific nodes</p>
      </div>
      <button
        onclick={() => loadDaemonSets($selectedNamespace)}
