...
<header class="h-14 bg-bg-secondary border-b border-border-subtle flex items-center px-4 gap-3">
  ...
  {#if $pulseMetrics}
    ...
    <div class="flex items-center gap-1.5 px-2.5 py-1 bg-bg-tertiary rounded-md border border-border-subtle">
      ...
      <span class="text-xs text-text-primary font-medium">{formatCpu($pulseMetrics.cpu_allocatable)}</span>
    </div>
    ...
    <div class="flex items-center gap-1.5 px-2.5 py-1 bg-bg-tertiary rounded-md border border-border-subtle">
      ...
      <span class="text-xs text-text-muted">Mem</span>
      <span class="text-xs text-text-primary font-medium">{formatMemory($pulseMetrics.memory_allocatable)}</span>
    </div>
  {/if}
